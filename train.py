...
# parser.add_argument('--root_path', type=str, default='/mnt/sdb/zhaoshiyu/endovis18/2D_all_5slice', help='root dir for data')
# parser.add_argument('--output', type=str, default='/mnt/sdb/zhaoshiyu/project_results/TDSAM_endovis18_12/result_20241211')
# parser.add_argument('--root_path', type=str, default='/mnt/sdb/zhaoshiyu/timesam_endovis18/endovis18/2D_all_5slice', help='root dir for data')
# parser.add_argument('--output', type=str, default='/mnt/sdb/zhaoshiyu/project_results/TDSAM_endovis18_8/result_20241211')
parser.add_argument('--root_path', type=str, default='/mnt/sdb/zhaoshiyu/endovis17_fold3_sam2/endovis17/2D_all_5slice', help='root dir for data')
parser.add_argument('--output', type=str, default='/mnt/sdb/zhaoshiyu/project_results/TDSAM_endovis17/result_fold3_20250106')
...
parser.add_argument('--stop_epoch', type=int, default=400, help='maximum epoch number to train')
...
parser.add_argument('--rank', type=int, default=128, help='Rank for FacT')
