...
def calc_loss(outputs, low_res_label_batch, ce_loss, dice_loss, dice_weight:float=0.8):
    ...
    # outputs = torch.softmax(low_res_logits, dim=1)
    breakpoint()
...
def trainer_run(args, model, snapshot_path, multimask_output, low_res):
    from datasets.dataset_endovis import dataset_reader, RandomGenerator
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            writer.add_scalar('info/loss_focal', loss_ce, iter_num)
